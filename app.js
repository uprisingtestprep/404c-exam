/* 404C Exam Simulator, Application Logic */

const ACCESS_CODE  = "404C9000";
const EXAM_SECONDS = 14400;
const PASSING_PCT  = 70;
const STORAGE_KEY  = "404c_exam_state_v1";
const SIM_Q_COUNT  = 130;  // simulator serves this project's configured pool size (config.json exam.sim_questions)
const CLUSTER_LABEL = "Case";
const DOMAIN_LABELS = {"common_occupational_skills": "Common Occupational Skills", "surface_preparation": "Surface Preparation", "residential_and_commercial_finishes": "Residential and Commercial Finishes", "wall_coverings": "Wall Coverings", "wood_finishes": "Wood Finishes", "industrial_coatings": "Industrial Coatings"};  // maps domain key -> human-readable label for display
